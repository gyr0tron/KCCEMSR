...
class FileUpload extends Model
{
  ...
  const admission_list = ['admission-criteria', 'fees-notices', 'institute-prospectus', 'dte-admission-information-brochure', 'cap-rount-allottment', 'direct-second-year', 'anti-ragging-affidavit', 'scholarship', 'mandatory-disclosure', 'aicte-affiliation', 'nirf-data', 'dte', 'university-affiliation', 'code-of-conduct', 'student-handbook', 'student-discipline'];
