<div class="box box-primary">
  <div class="box-header">
    <h3 class="box-title">Staff notices</h3>
  </div>
  <div class="box-body">
    <table id="academics-staff-notices" class="table table-bordered table-hover datatable-full">
      ...
      <tbody>
        @foreach (App\FileUpload::where("type","staff-notices")->get() as $fp)
          <tr>
            <td>{{$fp->name}}</td>
...
<div class="box box-primary">
  ...
  <div class="box-body">
    <form id="form-staff-notices" action="/api/admin/academics/staff-notices/add" method="post" enctype="multipart/form-data" class="form-horizontal" data-form="sr">
