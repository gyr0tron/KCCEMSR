				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="col-md-2 col-md-offset-1">
								<img src="{{ url("images/NDLI.png") }}" style="margin: 0 auto;" alt="" height="100" width ="100" class="img-responsive">
						</div>
						<div class="col-md-2">
								<img src="{{ url("images/delnet.jpg") }}" style="margin: 0 auto;" alt="" height="" width ="" class="img-responsive">
						</div>
						<div class="col-md-2">
								<img src="{{ url("images/Ietlogo.png") }}" style="margin: 0 auto;" alt="" height="100" width ="100" class="img-responsive">
						</div>
						<div class="col-md-2">
								<img src="{{ url("images/eshodh.png") }}" style="margin: 0 auto;" alt="" height="" width ="" class="img-responsive">
						</div>
						<div class="col-md-2">
								<img src="{{ url("images/IITB.png") }}" style="margin: 0 auto;" alt="" height="100" width ="100" class="img-responsive">
						</div>
					</div>
				</div>
			</div>
