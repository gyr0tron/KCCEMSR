...
(function (window) {
  ...
  if (true) {
    // AMD
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2)], __WEBPACK_AMD_DEFINE_FACTORY__ = (defineBridget),
...
;window.Modernizr = function (a, b, c) {
  function A(a) {
    ...
    var f,
      ...
      x = function x(b) {
    var c = a.matchMedia || a.msMatchMedia;if (c) return c(b) && c(b).matches || !1;var d;return w("@media " + b + " { #" + h + " { position: absolute; } }", function (b) {
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-62f52db1", Component.options)
  } else {
    hotAPI.reload("data-v-62f52db1", Component.options)
' + '  }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-62f52db1", module.exports)
  }
}
